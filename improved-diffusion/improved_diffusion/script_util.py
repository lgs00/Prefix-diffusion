...
def model_and_diffusion_defaults():
    ...
    return dict(
        ...
        training_mode='emb',
        vocab_size=66,
        config_name="pretrained/bert-base-uncased/",
        experiment_mode='lm',
        logits_mode=1,
    )
...
def create_model_and_diffusion(
    ...
    **kwargs,
    ...
    #config_name = '../classifier_models/e2e-tgt-tree_e=6_b=10_m=improved-diffusion/pretrained/bert-base-uncased/_wikitext-103-raw-v1_101_wp_None/'
    #config_name = 'improved-diffusion/diffusion_models/diff_e2e-tgt_block_rand16_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd102_xstart_e2e/'
    #config_name ='improved-diffusion/pretrained/bert-base-uncased/'
    config_name= 'pretrained/bert-base-uncased/'
    # config_name = 'pretrained/bert-large-uncased/'
    model = create_model(
        image_size,
        num_channels,
        num_res_blocks,
