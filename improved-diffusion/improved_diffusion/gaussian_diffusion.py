...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        self, model, x, t,image_feature, clip_denoised=True, denoised_fn=None, model_kwargs=None
    ):
        """
        得到reverse阶段的均值和方差
        ...
        model_output = model(x, self._scale_timesteps(t), **model_kwargs)   # 得到均值
        # model_var_type=ModelVarType.FIXED_SMALL: 2
