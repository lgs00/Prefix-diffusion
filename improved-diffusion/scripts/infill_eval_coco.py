...
def main():
    ...
    img_path= "../datasets/coco_vit_L14/coco_test_text_img.pkl"
...
def create_argparser():
    defaults = dict(
        data_dir="", clip_denoised=False, use_ddim=False, eta=1.0, num_samples=20, batch_size=1, model_path="",
        out_dir="generation_out/coco/1229/20ttt/",
