...
def main():
    ...
    train_out_path = '../datasets/flickr_vit/flickr_train_text_img.pkl'
    val_out_path = '../datasets/flickr_vit/flickr_val_text_img.pkl'
    test_out_path = '../datasets/flickr_vit/flickr_test_text_img.pkl'
